  ...
  return (
    <div>
      <div className="flex flex-col gap-4 mb-8 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button variant="contained" color="primary" onClick={() => guardAction({ action: 'create', permission: '/inventaris/create', onAllowed: () => router.push('/inventaris/create') })} className="w-full sm:w-auto">

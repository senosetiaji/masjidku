...
const ModalSuccess = (props) => {
  ...
  return (
    <Box className={`fixed left-0 right-0 top-0 bottom-0 ${open?'block':'hidden'} animate__animated ${backdropAnimation} animate__faster bg-[#25ad1931] filter backdrop-blur-xs z-999`}>
      <div className={`absolute left-0 right-0 m-auto top-1/4 animate__animated ${animation} animate__faster modal-box pb-4 bg-[#ffffffcb] backdrop-blur-lg border-12 list-inside border-white rounded-lg max-w-md shadow-md`}>
          ...
          <div className="text-center">
            ...
            <div className='mt-4'>
              <Button 
                ...
                size='sm'
                onClick={() => handleClose()}
                className={'m-auto text-white! py-2! px-6! bg-[#458d60]! hover:bg-[#387951]! border border-gray-300'}
              />
            </div>
          </div>
        </div>

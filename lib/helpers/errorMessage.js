const messages = {
  ...
  "missing_fields": "Data wajib belum lengkap. Mohon lengkapi semua field yang diperlukan.",
  "invalid_type": "Jenis zakat tidak valid.",
  "invalid_zakat_type": "Tipe zakat tidak valid.",
  "invalid_amount": "Jumlah zakat tidak valid.",
  "invalid_date": "Tanggal zakat tidak valid.",
  "zakat_not_found": "Data zakat tidak ditemukan.",
  "id_required": "ID data zakat wajib diisi.",
  "mustahik_not_found": "Data mustahik tidak ditemukan.",
  "invalid_role": "Kategori mustahik tidak valid.",
  "invalid_receiving_year": "Tahun penerimaan tidak valid.",
  "mustahik_created": "Data mustahik berhasil dibuat.",
  "mustahik_updated": "Data mustahik berhasil diperbarui.",
  "mustahik_deleted": "Data mustahik berhasil dihapus.",
};
